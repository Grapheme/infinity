        ...
        <div class="dtest-in">
            ...
            <div class="dtest-form">
                <form>
                    ...
                    <select class="testSelect hidden-model">
                        @foreach($header_models as $product_category)
                            @if($product_category->product->count())
                                @foreach($product_category->product as $product)
                                    @if($product->in_menu == 1)
    ...
    <div class="car-tooltip js-tooltip-block" data-tooltip="model-{{ $product->id }}">
        ...
        <div class="main-blocks">
            ...
            @endif
                ...
                <div class="car-btns">
                    <a href="javascript:void(0);" class="drive-btn js-pop-show" data-popup="test-drive-models" data-model="{{ $product->meta->first()->title }}"><span class="icon icon-wheel"></span>Записться на тестдрайв</a>
